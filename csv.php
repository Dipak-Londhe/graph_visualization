...
<body id="node1">
    ...
    <div class="container" id="container">
        ...
        <h2 class="h2"> Wireless Sensor Network </h2>
        <div class="nodes">
            <div class="level1">
                <?php
                ...
                $file = fopen("cfm-sensors-configuration-05.csv", "r");



                while ($result = fgetcsv($file)) {
                    if ($result[1] != "devicetype" || $result[2] != "macaddress") {
                        if ($result[1] == "coordinator-node") {
                            $dd = "<span class='cn'>" . $result[0] . "</span><span class='cnr' >" . $result[8] . "</span>";
            ...
            <div class="level2">
                ...
                while ($result = fgetcsv($file)) {
                    if ($result[1] != "devicetype" || $result[2] != "macaddress") {
                        if ($result[1] == "repeater-node") {
                            $dd = "<span class='rn'>" . $result[0] . "</span><span class='rnr' >" . $result[8] . "</span>";
            ...
            <div class="level3">
                ...
                while ($result = fgetcsv($file)) {
                    if ($result[1] != "devicetype" || $result[2] != "macaddress") {
                        ...
                        if ($result[1] == "sensor-node") {

                            $dd = "<span class='sn'>" . $result[0] . "</span><span class='snr' >" . $result[8] . "</span>";
